...
struct uArch
{
    ...
    virtual void writeRegister(mapped_reg aRegister, register_value aValue, bool isW = false, VirtualMemoryAddress thePC = VirtualMemoryAddress(0)) { DBG_Assert(false); }
